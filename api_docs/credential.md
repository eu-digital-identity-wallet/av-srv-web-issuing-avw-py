...
**Endpoint**: <https://issuer.ageverification.dev/credential> (or <https://localhost/credential> if installed locally)
...
**Example Requests:**
  ...
  ```Json
  {
      "credential_identifier": "eu.europa.ec.eudi.age_verification_mdoc",
      "proof": {
        "proof_type": "jwt",
  ...
  "proof": {
    "proof_type": "jwt",
    "jwt": "eyJ0eXAiOiJvcGVuaWQ0dmNpLXByb29mK2p3dCIsImFsZyI6IkVTMjU2IiwiandrIjp7Imt0eSI6IkVDIiwiY3J2IjoiUC0yNTYiLCJ4IjoibkNheC1hdkdaZ1RaMkpFR3dqYmQzVDVjZ3FxNEtKeC1UZjBNYjJTaEtwdyIsInkiOiJDeW1oM3k5eEZ2YVVLMDlid1c2R0VOZWpQVU9razA0LTk1bWxySldkdzNrIn19.eyJpc3MiOiJ3YWxsZXQtZGV2IiwiYXVkIjoiaHR0cHM6Ly9pc3N1ZXIuYWdldmVyaWZpY2F0aW9uLmRldiIsIm5vbmNlIjoiT0lsVTNQdGs4MWQzSVZhNUZQTVV4ZyIsImlhdCI6MTc0NjE4MzgwNn0.1e-7JR4ejGJjJNHfTyMJciVRCoYO8HnNAM4fIq4OZB5eEeU9mKZZNLlAqQ-bolTT9JPgvIWYRIKn9wGmu_XCJA"
  }
}
  ```
